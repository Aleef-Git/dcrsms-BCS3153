...
<body>
    <form action="{{ route('cash_on_delivery.update', ['cash_on_delivery'=>$cash_on_delivery]) }}" method="post" id="payment-form">
        ...
        <br>
        <button style="background-color: red" type="submit" id="complete-order" class="button-primary full-width">Pay
            with Visa or MasterCard</button>
    </form>
    ...
    <script>
        (function() {
            ...
            var stripe = Stripe(
                'pk_test_51IrepxK80Zk2XVKDjWkJxTpl6kbMcTFXlZAbdLYtgJidALwhOt0kC5ZxMXYSPSlXuS8f0XqtHmj7unhAKoTYfwAD00ke13z4eA'
            );
